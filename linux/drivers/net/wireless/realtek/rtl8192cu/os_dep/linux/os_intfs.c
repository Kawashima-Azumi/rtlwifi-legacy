...
static u16 rtw_select_queue3(struct net_device *dev, struct sk_buff *skb,
	void *accel_priv, select_queue_fallback_t fallback)
{
	return rtw_select_queue(dev, skb);
}
#elif (LINUX_VERSION_CODE>=KERNEL_VERSION(3,13,0))
static u16 rtw_select_queue2(struct net_device *dev, struct sk_buff *skb,
	void *accel_priv)
{
	return rtw_select_queue(dev, skb);
}
...
#if (LINUX_VERSION_CODE>=KERNEL_VERSION(3,14,0))
	.ndo_select_queue	= rtw_select_queue3,
#elif (LINUX_VERSION_CODE>=KERNEL_VERSION(3,13,0))
	.ndo_select_queue	= rtw_select_queue2,
