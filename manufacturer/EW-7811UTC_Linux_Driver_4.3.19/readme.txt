...
===============================================================================
	...
	2. document/
		...
		2.18 Quick_Start_Guide_for_Adaptivity_and_Carrier_Sensing_Test.pdf

	3. driver/
		3.1 rtl8821AU_linux_v4.3.19.5_17672.20160506_BTCOEX20150921-58.tar.gz
			Naming rule: rtlCHIPS_WiFi_linux_vM.N.P_ssss.yyyymmdd_BTCOEXYYYYMMDD-SS.tar.gz
			where:
				...
				m: package month
				d: package day
				BTCOEXYYYYMMDD-SS: BT-Coexistence version
	...
	4. wpa_supplicant_hostapd/
		...
		4.8 wpa_supplicant_8_L_5.x_rtw_r14967.20150811.tar.gz
			 wpa_supplicant_8 from Android 5 SDK and patched by Realtek
			 could be used for pure-linux Android 5 Support only cfg80211/nl80211.
...
==================================================================================================================
		...
		Wi-Fi Direct with nl80211
			(*) Please use:
				  wpa_supplicant_8_jb_4.2_rtw_r12454.20141003.tar.gz
				or
				  wpa_supplicant_8_kk_4.4_rtw_r12456.20141003.tar.gz
